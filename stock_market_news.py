...
if __name__ == '__main__':
    ...
    feed_title = "股市新闻-英为财情"  # feed的标题，会显示在feed阅读器中
    feed_description = "股市新闻_今日股市最新消息_股票新闻头条_英为财情Investing.com"  # feed的描述
    feed_name =  "stock_market_news.xml"  # feed xml文件的的名字
    website_url = 'https://cn.investing.com/news/stock-market-news'  # 要爬取的页面
