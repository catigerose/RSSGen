...
if __name__ == '__main__':
    ...
    feed_title = "经济新闻-英为财情"  # feed的标题，会显示在feed阅读器中
    feed_description = "经济新闻_每日经济新闻快讯_英为财情Investing.com"  # feed的描述
    feed_name =  "economy_investing.xml"  # feed xml文件的的名字
    website_url= 'https://cn.investing.com/news/economy'  # 要爬取的页面
